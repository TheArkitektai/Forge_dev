...
export type ExtractedStoryCandidate = {
  title: string;
  description: string;
...
export type StakeholderViewId = "cto" | "engineer" | "product" | "security" | "devops";

export type ArtifactTypeConfig = {
  id: ArtifactTypeId;
  label: string;
  description: string;
  outputType: "mermaid" | "text";
  contextPassMode: "raw" | "summarizable";
  prerequisites: ArtifactTypeId[];
  mandatory: boolean;
  scope: "project" | "epic" | "story";
  renderer: "xyflow" | "plantuml" | "table" | "markdown";
  stakeholderViews: StakeholderViewId[];
  agentName: string;
};

export type StoryDesignArtifact = {
