                      ...
                      >
                        ...
                        <div className="space-y-2">
                          {notifications.map(item => (
                            <div
                              key={item.id}
                              className="rounded-[14px] border border-slate-200 bg-slate-50/70 p-3 transition hover:border-sky-200 hover:bg-white cursor-pointer"
                              onClick={() => {
                                if (item.actionUrl) {
                                  setShowNotifications(false);
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex flex-wrap gap-2">
                        {selectedStory ? (
                          ...
                          <span className="rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-sm text-slate-700">No active story</span>
                        )}
                      </div>
                    </div>
